...
import cherokee.conjugation.verbal.containers.Prefix
import cherokee.conjugation.verbal.containers.VerbCompoundPrefix
import cherokee.conjugation.verbal.containers.VerbCompoundPrefixes
import cherokee.conjugation.verbal.containers.VerbFinalSuffixHolderObject
...
//        verb.partOfSpeech = verbType
        verb.partOfSpeech = verbType == 'v.i.' ? PartOfSpeech.VERB_INTRANSITIVE : PartOfSpeech.VERB_TRANSITIVE
        ...
        def finalSuffixTrueValue = str.indexOf(verb.finalSuffix.getTrueValue())
        println(finalSuffixTrueValue)
        if (finalSuffixTrueValue > 0) {
            verb.verbRootLatinPhonetic = str.substring(0, finalSuffixTrueValue - 1)
        }
