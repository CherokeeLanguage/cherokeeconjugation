...
class Morphemes {
    ...
    /**
     * this takes the character and prefix and through Groovy reflection it calls the correct method to process the result
     *
     * @param firstChar
     * @param prefix
     * @param it
     * @return
     */
    static def fixPrefix(firstChar, prefix, it) {
