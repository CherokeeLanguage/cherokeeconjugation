...
class NormalizedVerbEntry {
    ...
    static void removeDirectObject(NormalizedVerbEntry e) {
...
//		System.out.println("Found direct object: '"+object+"'");
    ...
    static void removeIprefix(NormalizedVerbEntry e) {
    ...
    static void removeWiprefix(NormalizedVerbEntry e) {
    ...
    static void removeNiprefix(NormalizedVerbEntry e) {
        //they and I
    ...
    static void removeDeprefix(NormalizedVerbEntry e) {
