...
/**
 * This is a generic holder for the tense versions pulled from the stemmer
 * TODO: this includes the suffix ending - this will have to be dealt with when adding non-final suffixes
 *
