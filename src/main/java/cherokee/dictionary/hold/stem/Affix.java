...
//    protected final Logger logger = Log.getGwtLogger(new ConsoleLogHandler2(), this.getClass().getSimpleName());
    ...
    public static class Repeatedly extends Affix {
    ...
    private static class CausativePresent extends Affix {
        @Override
        public AffixResult match(String syllabary) {
    ...
    private static class CausativePast extends Affix {
        @Override
        public AffixResult match(String syllabary) {
            AffixResult match = super.match(syllabary);
            if (!match.isMatch) {
    ...
    private static class CausativeProgressive extends Affix {
        @Override
        public AffixResult match(String syllabary) {
            AffixResult match = super.match(syllabary);
            if (!match.isMatch) {
...
//            logger.info("OFORM: "+oform);
    ...
    private static class CausativeImmediate extends Affix {
    ...
    private static class CausativeDeverbal extends Affix {
    ...
    public static class Causative extends Affix {
        private final List<Affix> forms = new ArrayList<Affix>();

        @Override
        public AffixResult match(String syllabary) {
            for (Affix affix : forms) {
    ...
    public static class ToForᏏ extends Affix {
        public ToForᏏ() {
            completiveStem = false;
            addSet("", "Ꮟ");
        }
    ...
    public static class ToFor extends Affix {
        public ToFor() {
            // prc
            addSet("Ꭱ", "Ꭽ");
            // past
    ...
    public static class Again extends Affix {
    ...
    public static class AboutTo extends Affix {
        public AboutTo() {
            completiveStem = false;
    ...
    public static class IntendTo extends Affix {
        public IntendTo() {
            completiveStem = true;
            // progressive
            addSet("Ꭲ", "ᏎᏍᏗ");
    ...
    public static class Just extends Affix {
        public Just() {
            completiveStem = false;
            // 1844
            addSet("", "Ꮙ");
    ...
    public static class Very extends Affix {
        public Very() {
            completiveStem = false;
            addSet("", "Ᏻ");
        }
    ...
    public static class Truly extends Affix {
        public Truly() {
            completiveStem = false;
            addSet("", "Ꮿ");
            addSet("", "ᏯᎢ");
    ...
    public static class Towards extends Affix {
        public Towards() {
            completiveStem = false;
            // 1844
            addSet("", "ᏗᏢ");
    ...
    public static class But extends Affix {
        public But() {
            completiveStem = false;
            addSet("", "ᏍᎩᏂ");
        }
    ...
    public static class YesNo extends Affix {
        public YesNo() {
            completiveStem = false;
            addSet("", "Ꮝ");
            addSet("", "ᏍᎪ");
    ...
    public static class YesYes extends Affix {
        public YesYes() {
            completiveStem = false;
            addSet("", "Ꮷ");
        }
    ...
    public static class Place extends Affix {
        public Place() {
            completiveStem = false;
            // 1844
            addSet("", "Ᏹ");
    ...
    public static class InOnAt extends Affix {
        @Override
        public AffixResult match(String syllabary) {
            AffixResult match = super.match(syllabary);
            if (!match.isMatch) {
    ...
    public static class SoAnd extends Affix {
        public SoAnd() {
            completiveStem = false;
            addSet("", "Ꮓ");
        }
    ...
    public static class WithIntent extends Affix {
    ...
    public static class WentForDoing extends Affix {
    ...
    public static class ComeForDoing extends Affix {
    ...
    public static class Around extends Affix {
    ...
    public static class Completely extends Affix {
    ...
    public static class Accidental extends Affix {
    ...
    public static class AptTo extends Affix {
        public AptTo() {
            // present
            addSet("Ꭰ", "Ꮤ");
            // progressive
